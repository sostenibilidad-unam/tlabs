...
action_cat_color = {
    ...
    'Funding': 'grey',
    'Collaboration': 'red',
    'Financial/commercial training': 'gold',
...
for cat in sorted(Category.objects.all(), key=by_degree):
    ...
    g = svgwrite.container.Group(style='font-size:24;')
    g.add(n.dwg.text(cat.name,
                     insert=(n.x - size * 0.91, n.y + 7),
                     text_anchor='end'))
    n.dwg.add(g)
            ...
            if alter in alter_axis.nodes \
               and (args.sector == 'all'
                ...
                h.connect(axis_egos, ego,
                          ...
                          stroke_width=1.5,
                          stroke_opacity=0.3,
                          stroke=sector_grey[alter.sector.name],)
